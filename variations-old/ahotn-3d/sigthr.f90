...
ELSE
   ...
   DO pk = 0, npz-1
      ...
      DO pj = 0, npy-1
         ...
         DO pi = 0, npx-1
            coord(1) = pi
            eqs = nxvec(pi)*nyvec(pj)*nzvec(pk)*ordcb*ng
            CALL MPI_CART_RANK(allcomm,coord,trank,ierr)
            IF (trank /= nrank) THEN
               ALLOCATE(tmpf(nxvec(pi),nyvec(pj),nzvec(pk),0:lambda,0:lambda,0:lambda,ng))
               tmpf = 0.0
               tag = 100 + trank
                     ...
                     DO u = 0, lambda
                        DO v = 0, lambda
                           DO k = 1, nzvec(pk)
                              DO j = 1, nyvec(pj)
                                 DO i = 1, nxvec(pi)
                                    flux(i+indx,j+jndx,k+kndx,t,u,v,g) = tmpf(i,j,k,t,u,v,g)
                                 END DO
                              END DO
                           END DO
                        END DO
                     ...
                     DO u = 0, lambda
                        DO v = 0, lambda
                           DO k = 1, nz
                              DO j = 1, ny
                                 DO i = 1, nx
                                    flux(i+indx,j+jndx,k+kndx,t,u,v,g) = f(i,j,k,t,u,v,g)
                                 END DO
                              END DO
                           END DO
                        END DO
