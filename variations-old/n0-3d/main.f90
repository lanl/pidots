...
!  By RJZerr, December 2010 (Special Version: AHOT-N0) 
!
...
!   Update the previous version to include:
!     Apply all other PBJ updates thru 12/2010 (transpose, new solvers, etc.)
!     Use MPI_WTIME()
!     Retain gammas for AHOT-NO spatial discretization
!
!
!-----------------------------------------------------------------------------------
