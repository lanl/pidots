SUBROUTINE jima(sdi,i,j,k,xs,ys,zs,xe,ye,ze,incx,incy,incz,n,c,oct)
...
jmat(jeq,jeq,sdi) = jmat(jeq,jeq,sdi) + wt*c*gaa
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ...
            jmat(ieq,jeq,sdi) = jmat(ieq,jeq,sdi) + wt*gayz*xold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (j /= ys) THEN
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*sdnx + (kk-1)*xys
            jmat(ieq,jeq,sdi) = jmat(ieq,jeq,sdi) + wt*gaxz*yold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (k /= zs) THEN
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*sdnx + (kk-1)*xys
            jmat(ieq,jeq,sdi) = jmat(ieq,jeq,sdi) + wt*gaxy*zold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (k == ze) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*sdnx + (kk-1)*xys
            jpsi(ieq,jeq,oct,sdi) = zmat(ii,jj,kk,i,j)
         END DO
      END DO
   END DO
END IF
IF (j == ye) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*sdnx + (kk-1)*xys
            jpsi(ieq,jeq,oct,sdi) = ymat(ii,jj,kk,i)
         END DO
      END DO
   END DO
END IF
IF (i == xe) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*sdnx + (kk-1)*xys
            jpsi(ieq,jeq,oct,sdi) = xmat(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
