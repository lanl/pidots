...
!   Parallel GMRES solution sequence to replace Parallel Block Jacobi
!   User has choice of Classical Gram-Schmidt or Modified Gram-Schmidt
!    orthogonalization techniques
!   User can apply a diagonal block preconditioner if desired
!
!-----------------------------------------------------------------------------------
