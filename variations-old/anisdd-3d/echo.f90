...
END IF
WRITE (8, '(2X, A1, T8, A2, T16, A3, T26, A2, T35, A5, T44, A1)') "n", "mu", "eta", "xi", "omega", "w"
DO n = 1, apo
   WRITE (8, '(1X, I2, T6, F7.5, T15, F7.5, T24, F7.5, T33, F7.5, T42, F7.5)') n, ang(n,1), ang(n,2), ang(n,3), omg(n), w(n)
END DO
