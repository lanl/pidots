...
WRITE (8,105) "Maximum number of V-Cycles = ", vitmx
WRITE (8,105) "Maximum number of pre-correction parallel block iterations = ", bitmx1
WRITE (8,105) "Maximum number of post-correction parallel block iterations = ", bitmx2
