SUBROUTINE conk(n,i,j,k,incx,incy,incz,xs,ys,zs,wt,ktmpz,ktmpy,ktmpx)
...
REAL*8, INTENT(IN) :: wt
REAL*8, DIMENSION(xys), INTENT(OUT) :: ktmpz
REAL*8, DIMENSION(xzs), INTENT(OUT) :: ktmpy
REAL*8, DIMENSION(yzs), INTENT(OUT) :: ktmpx
