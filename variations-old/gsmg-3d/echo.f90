...
WRITE (8,106) "Direct solution by factorization for each sub-domain each global iteration."
...
WRITE (8,'(1X,A,I3,A1,I3,A1,I3)') "Sub-domain size ", sdnx, "x", sdny, "x", sdnz
WRITE (8,'(1X,A,I3,A1,I3,A1,I3)') "Sub-domain divisions ", nxsd, "x", nysd, "x", nzsd
WRITE (8,105) "Number of sub-domains per processor = ", nsdp
...
WRITE (8,105) "Maximum number of v-cycle iterations = ", vitmx
WRITE (8,105) "Maximum number of pre-correction iterations = ", bitmx1
WRITE (8,105) "Maximum number of post-correction iterations = ", bitmx2
WRITE (8,107) "Pointwise convergence criterion = ", err
WRITE (8,105) "Number of v-cycle stages = ", ns
