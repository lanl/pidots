...
!   bitmx1 => Parallel GS maximum number of iterations, pre-correction
!   bitmx2 => Parallel GS maximum number of iterations, post-correction
...
CALL MPI_BCAST(ipak,30,MPI_INTEGER,irank,MPI_COMM_WORLD,ierr)
