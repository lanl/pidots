...
!   bitmxn => Parallel block Jacobi maximum number of iterations
!   itmx   => Maximum number of iterations
!   tolr   => Tolerence for Convergence Check: determine whether abs or rel difference
READ(7,*) err, cgr, bitmxn, itmx, tolr
...
! Read the iteration controls
READ(7,*) vitmx, bitmx, bitmx2
...
CALL MPI_BCAST(ipak,22,MPI_INTEGER,irank,MPI_COMM_WORLD,ierr)
