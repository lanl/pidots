SUBROUTINE jima(i,j,k,xs,ys,zs,xe,ye,ze,incx,incy,incz,n,c,oct,v)
...
jmat(jeq,jeq,v) = jmat(jeq,jeq,v) + wt*c*gaa
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ...
            jmat(ieq,jeq,v) = jmat(ieq,jeq,v) + wt*gayz*xold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (j /= ys) THEN
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*nx + (kk-1)*xys
            jmat(ieq,jeq,v) = jmat(ieq,jeq,v) + wt*gaxz*yold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (k /= zs) THEN
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*nx + (kk-1)*xys
            jmat(ieq,jeq,v) = jmat(ieq,jeq,v) + wt*gaxy*zold(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
...
IF (k == ze) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*nx + (kk-1)*xys
            jpsi(ieq,jeq,oct,v) = zmat(ii,jj,kk,i,j)
         END DO
      END DO
   END DO
END IF
IF (j == ye) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*nx + (kk-1)*xys
            jpsi(ieq,jeq,oct,v) = ymat(ii,jj,kk,i)
         END DO
      END DO
   END DO
END IF
IF (i == xe) THEN
   ...
   DO kk = zs, k, incz
      DO jj = ys, j, incy
         DO ii = xs, i, incx
            ieq = ii + (jj-1)*nx + (kk-1)*xys
            jpsi(ieq,jeq,oct,v) = xmat(ii,jj,kk)
         END DO
      END DO
   END DO
END IF
